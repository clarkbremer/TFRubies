...
c2 = mm.entities.add_instance(c1.definition, Geom::Transformation.new([20,30,0]))
...
puts "path 2 valid: #{path2.valid?}"
point2 = v2.position
point2.transform! c2.transformation
puts "point2: #{point2}"


mm.active_entities.add_dimension_linear([path1, point1], [path2, point2], [-30, 0, 0])
